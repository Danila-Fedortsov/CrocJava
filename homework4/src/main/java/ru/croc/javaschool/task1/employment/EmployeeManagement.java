...
public class EmployeeManagement {
     ...
     * сотрудников на кольца. Если колец нет, то можно гарантировать, что список корректен, тк в таком случае всегда
     * найдётся хотя бы один самый главный сотрудник являющийся вершиной нашего иерархического дерева.
     *
     * @param employees список сотрудников
